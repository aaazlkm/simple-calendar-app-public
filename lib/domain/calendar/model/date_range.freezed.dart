...
class _$DateRangeTearOff {
  ...
  _DateRange call({required DateTime start, required DateTime end}) {
    return _DateRange(
      start: start,
      end: end,
    );
...
class _$_DateRange extends _DateRange with DiagnosticableTreeMixin {
...
abstract class _DateRange extends DateRange {
  const factory _DateRange({required DateTime start, required DateTime end}) =
      _$_DateRange;
